################################################################################
# scenario: 2 sub-populations (G=2)
################################################################################
...
data <- list(longitudinal=rbind(data1$longitudinal,data2$longitudinal), survival=rbind(data1$survival,data2$survival), raneff=rbind(data1$b,data2$b))
