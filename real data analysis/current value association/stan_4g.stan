...
// ------------------------------------------------------
  ...
  Haz3 = lambda3 * pow(Time, lambda3 - 1) .* 
                 exp(beta3[1] + beta3[2] * x1 + beta3[3] * x2 + beta3[4] * (x1 .* x2) + alpha3 * (theta3[1] + b3i[,1] + (theta3[2] + b3i[,2]) .* Time + (theta3[3] + b3i[,3]) .* square(Time) + theta3[4] * x1));
  Haz4 = lambda4 * pow(Time, lambda4 - 1) .* 
                 exp(beta4[1] + beta4[2] * x1 + beta4[3] * x2 + beta4[4] * (x1 .* x2) + alpha4 * (theta4[1] + b4i[,1] + (theta4[2] + b4i[,2]) .* Time + (theta4[3] + b4i[,3]) .* square(Time) + theta4[4] * x1));
   ...
   for (j in 1:K) {
      ...
      vector[n] adjLP3 = theta3[1] + b3i[,1] + (theta3[2] + b3i[,2]) .* adjTime[, j] + (theta3[3] + b3i[,3]) .* square(adjTime[, j]) + theta3[4] * x1;
      vector[n] adjLP4 = theta4[1] + b4i[,1] + (theta4[2] + b4i[,2]) .* adjTime[, j] + (theta4[3] + b4i[,3]) .* square(adjTime[, j]) + theta4[4] * x1;
