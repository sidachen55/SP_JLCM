...
init_function <- function() {
  list(
    ...
    theta3 = (matrix(fit_summary[,"coef"], 4, 4)[4,])* runif(1,0.7,1.4),
    psi1 = rnorm(3,0,1),
    psi2 = rnorm(3,0,1),
    psi3 = rnorm(3,0,1)
  )
...
# as expected, mixing for parameters associated with the 'tiny' cluster is poor due to weak identifiability
...
save(IC_smy, file=paste0("IC_smy_4g.rdata"))
